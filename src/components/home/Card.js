    ...
    return (
      ...
      >
        <div className="aspect-square bg-gray-100 dark:bg-gray-800 w-full relative">
          ...
          <div className="absolute left-3 top-3 right-3 text-white rounded-md bg-dark/60">

            <h3 className="px-3 py-1 text-lg font-semibold truncate">{item.title}</h3>
            <p className="px-3 py-1 text-sm font-semibold mt-1 line-clamp-7">{item.description}</p>
